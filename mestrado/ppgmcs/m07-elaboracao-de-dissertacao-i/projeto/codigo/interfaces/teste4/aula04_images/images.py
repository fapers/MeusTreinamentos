...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.image1.move(40, 0)
        self.image1.resize(200, 200)
        self.image1.setPixmap(QtGui.QPixmap('images/settings.png'))
    ...
    def button1_click(self):
        ...
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;\
             color:"red";}')
        self.image1.setPixmap(QtGui.QPixmap('images/executar.png'))

    def button2_click(self):
        self.label_1.setText("      Turmas Cadastradas      ")
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;\
             color:"green";}')
        self.image1.setPixmap(QtGui.QPixmap('images/turmas.png'))

    def button3_click(self):
        self.label_1.setText("    Professores Cadastrados   ")
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;\
             color:"green";}')
        self.image1.setPixmap(QtGui.QPixmap('images/professora.png'))

    def button4_click(self):
        self.label_1.setText("       Matriz Curricular      ")
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;\
             color:"gray";}')
        self.image1.setPixmap(QtGui.QPixmap('images/solucao.png'))

    def button5_click(self):
        self.label_1.setText("        Disponibilidade       ")
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;\
             color:"gray";}')
        self.image1.setPixmap(QtGui.QPixmap('images/disponibilidade.png'))

    def button6_click(self):
        self.label_1.setText("    Parâmetros e Restrições   ")
        self.label_1.setStyleSheet('QLabel {font:bold; font-size:25px;\
             color:"gray";}')
        self.image1.setPixmap(QtGui.QPixmap('images/restricoes.png'))
