...
"}")
        ...
        self.Pages_Widgets = QStackedWidget(self.frame_page)
        self.Pages_Widgets.setObjectName(u"Pages_Widgets")
        self.page = QWidget()
        self.page.setObjectName(u"page")
        self.Pages_Widgets.addWidget(self.page)
        self.page_2 = QWidget()
        self.page_2.setObjectName(u"page_2")
        self.Pages_Widgets.addWidget(self.page_2)

        self.verticalLayout_5.addWidget(self.Pages_Widgets)
